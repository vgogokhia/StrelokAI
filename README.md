...
- `Dockerfile`, `deploy/Caddyfile`, `railway.json` — Railway deployment (Node account service + static PWA).
...
- `server/` — Google sign-in and account profile sync; see `server/README.md` for required deployment configuration.
